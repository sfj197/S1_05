...
public class Serializar {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		try {
			...
			ObjectOutputStream nuevoFichero= new ObjectOutputStream(new FileOutputStream("C:/Users/Jorge/Desktop/ser/alumno.ser"));
			nuevoFichero.writeObject(alumnos);
			nuevoFichero.close();
			
			//Deserializamos el objeto y mostramos por consola.
			ObjectInputStream recuperarFichero = new ObjectInputStream(new FileInputStream("C:/Users/Jorge/Desktop/ser/alumno.ser"));
